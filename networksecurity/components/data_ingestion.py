...
##call the configuration file for data ingestion config
...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        """
        reading data from mongoDB and converting it to dataframe
        """
        try:
    ...
    #step 2 -> nwow e need to export data to feature store file path
    ##we will read the data from dataframe and store it as csv under file path
    ...
    ##step3 -> divide the data train and test splits and 
    ...
    def initiate_data_ingestion(self):
        try:
            ##now her we need to ahve a data as df
